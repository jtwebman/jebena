...
- [~] java.util: Objects, ArrayList(List), HashMap(Map), HashSet(Set) with Collection/List/Set/Map/Map.Entry interfaces (polymorphic declared types + invokeinterface work), keySet/values/entrySet views. Remaining: real Arrays (asList/toString/copyOfRange), LinkedList/TreeMap/LinkedHashMap. Comparable/Comparator/Collections now real

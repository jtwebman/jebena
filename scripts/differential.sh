...
BREADTH='DiffColl|DiffRegex|DiffRegex2|DiffStream|DiffStream2|DiffString|DiffTrace|DiffBits|DiffFmt|DiffBig|DiffNav|DiffList|DiffMath|DiffMath2|DiffChar|DiffMap|DiffRandom|DiffPQ|DiffTok|DiffVec|DiffStk|DiffUuid|DiffOptInt|DiffADq|DiffBitSet|DiffScanner|DiffCmp|DiffBigDec|DiffBigDec2|DiffBigDec3|DiffCollectors|DiffDow|DiffDecFmt|DiffPath|DiffIntStream|DiffDate2|DiffB64|DiffCrc|DiffLongStream|DiffDoubleStream|DiffDtf|DiffGauss|DiffStrBytes|DiffHex|DiffTimeUnit|DiffColl2|DiffRegex3|DiffZoneOffset|DiffBitSet2|DiffSB2|DiffStream3|DiffChar2|DiffBigInt2'
